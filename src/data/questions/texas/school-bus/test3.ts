...
export const texasSchoolBus3: Question[] = [
  {
    id: 'sb3-1',
    ...
    answers: ['When loading or unloading students', 'Only during emergencies', 'Only at railroad crossings', 'Whenever the bus stops'],
    ...
    questionTag: 'school bus3'
  },
  {
    id: 'sb3-2',
    question: 'When is the only time the red warning lights can be used?',
    answers: ['During loading or unloading', 'When parked', 'In emergencies', 'At railroad crossings'],
  ...
  // Add more school bus test 3 questions
];